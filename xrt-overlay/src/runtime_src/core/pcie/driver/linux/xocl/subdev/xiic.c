...
static struct i2c_adapter xiic_adapter = {
	.owner = THIS_MODULE,
	/* I2C_CLASS_SPD was removed in Linux 6.10 (SDRAM SPD i2c class no
	 * longer used by the kernel). The HWMON hint is what actually matches
	 * the LM63 thermal chip on this bus. */
